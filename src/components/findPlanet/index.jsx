...
const FindPlanet = () => {
    ...
    if (
        token.loading ||
        searchPlanetResult.loading ||
        !searchPlanetResult.result.status
    )
    ...
    const getSuccessDescription = () => {
        return (
            <React.Fragment>
                ...
                Found <strong>{searchPlanetResult.result.planet_name}</strong>{' '}
                planet in <strong>{totalTime}</strong> hours.
                <br />
                <br />
                {getStartAgainButton()}
            </React.Fragment>
