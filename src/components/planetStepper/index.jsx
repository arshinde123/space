...
class PlanetStepper extends React.Component {
    ...
    handlePlanetChange = (event, selectedPlanet, reason, step) => {
        ...
        if (reason === 'selectOption') {
            ...
            let previousId =
                stepData[step].selectedPlanet &&
                stepData[step].selectedPlanet.id;
    ...
    handleVehicleChange = (event, step) => {
        ...
        if (event.target.value) {
            ...
            if (!stepData[step]) stepData[step] = {};
            let previousId =
                stepData[step].selectedVehicle &&
                stepData[step].selectedVehicle.id;
    ...
    getStepOptionalLabel = (step) => {
        ...
        return (
            <StepOptionalLabel
                ...
                selectedVehicle={
                    stepData[step] && stepData[step].selectedVehicle
                }
            />
        );
    };
